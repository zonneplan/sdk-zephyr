...
static struct flash_parameters _flashparams;
...
int nvs_init(struct nvs_fs *fs, const char *dev_name)
{
	...
	_flashparams.erase_value = 0xff;
	_flashparams.write_block_size = fs->write_block_size;
	fs->flash_parameters = &_flashparams;
